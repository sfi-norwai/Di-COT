...
<p align="center">
  ...
  <img alt="Last Commit" src="https://img.shields.io/github/last-commit/sfi-norwai/Di-COT">
  <img alt="Stars" src="https://img.shields.io/github/stars/sfi-norwai/Di-COT?style=social">
</p>

<p align="center">
  <a href="https://icml.cc/virtual/2026/poster/66203">
    <img alt="ICML 2026 Accepted" src="https://img.shields.io/badge/Accepted%20at-ICML%202026-blueviolet">
  </a>
</p>


This repository contains the official Pytorch implementation of the "[**Divide and Contrast (Di-COT)**]" (ICML 2026), an unsupervised framework that avoids data augmentation and multiple encoder passes by contrasting informative sub-structures within an instance rather than individual timesteps.
